...
class sCTkFrameLabeledPrimary(ctk.CTkScrollableFrame, ThemeableWidget):
    ...
    WHITELIST GUARD: if a composite widget inherits sCTkFrameLabeledPrimary as
    its own base class and explicitly calls ThemeableWidget.__init__ itself
    ...
    construction of a plain sCTkFrameLabeledPrimary, final_kw already only
